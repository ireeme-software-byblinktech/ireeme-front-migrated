...
export function AddTeacherModal({ isOpen, onClose }: AddTeacherModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Logic to add teacher would go here
    onClose();
  };

  return (
    <div className="fixed inset-0 z-50">
      {/* Background overlay excluding sidebar area (64px/16rem or var) */}
        ...
        <div className="bg-black text-white rounded-2xl w-full max-w-xl shadow-2xl pointer-events-auto overflow-hidden">
          ...
          <div className="flex items-center justify-between p-6 border-b border-white/10">
            <div>
              ...
              <p className="text-gray-400 text-xs mt-1">Enter the details of the new teacher to join the system.</p>
            </div>
