...
import { Plus, X, Bold, Italic, Underline, AlignLeft, AlignCenter, AlertCircle, FileText } from "lucide-react";
      ...
      <form onSubmit={(e) => onSubmit(e, false)} className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-bold text-gray-900 mb-2">
              Due Date <span className="text-gray-500 font-normal">(optional for drafts)</span>
            </label>
            <input
              type="datetime-local"
        ...
        <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
          ...
          <button
            ...
            className="px-6 py-2.5 rounded-lg border-2 border-gray-300 text-gray-700 font-semibold text-sm hover:bg-gray-50 disabled:opacity-50 transition-colors flex items-center gap-2"
          >
            {isSubmitting ? (
              <>
