      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 bg-white border border-gray-100 rounded-xl shadow-sm min-h-[500px]">
            ...
            <div className="p-8">
              ...
              <div className="flex items-center gap-6 mb-8 pb-8 border-b border-gray-100">
                <div className="relative group cursor-pointer">
                  <img src="https://ui-avatars.com/api/?name=Alex+Johnson&background=0D8ABC&color=fff&size=120" alt="Avatar" className="w-24 h-24 rounded-full object-cover shadow-sm bg-gray-50 border border-gray-200" />
          ...
          {activeTab === "notifications" && (
            <div className="p-8">
              ...
              <div className="space-y-6">
                {[
                  { key: 'emailAlerts', title: 'Email Alerts', description: 'Receive important updates and announcements via email.' },
                  { key: 'pushNotifications', title: 'Push Notifications', description: 'Get live push notifications when your grades change or you receive a message.' },
                  { key: 'smsAlerts', title: 'SMS Text Alerts', description: 'Receive critical alerts like school closures directly to your phone number.' },
                  { key: 'weeklyDigest', title: 'Weekly Digest', description: 'A weekly summary email of your progress and upcoming assignments.' },
                ].map((item) => (
            ...
            <div className="p-8">
              ...
              <div className="mb-8 p-6 bg-gray-50 border border-gray-100 rounded-xl">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-gray-900">Authentication Method</h3>
                    <p className="text-sm text-gray-600 mt-1 mb-4">You are currently logging in using your Student ID and Password. We recommend enabling two-factor authentication.</p>
                    <button onClick={() => alert("Redirecting to 2FA Setup...")} className="px-4 py-2 bg-white border border-gray-200 rounded-md text-sm font-medium hover:bg-gray-50 transition-colors shadow-sm">Enable Two-Factor (2FA)</button>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 max-w-md">
                  ...
                  <button className="px-4 py-2.5 mt-2 bg-gray-900 text-white rounded-md text-sm font-medium hover:bg-black transition-colors">Update Password</button>
                </div>
              </div>
            </div>
          )}
          ...
          {activeTab === "preferences" && (
            <div className="p-8">
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="font-semibold text-gray-900 mb-4">Display Theme</h3>
          ...
          <div className="px-8 py-5 border-t border-gray-100 bg-gray-50/50 flex items-center justify-between rounded-b-xl">
            <p className="text-sm text-gray-500">Unsaved changes will be lost.</p>
            <div className="flex items-center gap-3">
              <button className="px-5 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-100 rounded-md transition-colors">Cancel</button>
              <button 
                onClick={handleSave} 
